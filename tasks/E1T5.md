# E1T5 — Client Info Collection

**Weight:** 0.0000 (share of project budget)
**Reward:** 0 MCUTS

Collect client name (prefilled from Telegram) and required phone number. Write tests/specs/E1T5.json and update tests/commands.json.
