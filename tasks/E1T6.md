# E1T6 — Booking Confirmation Dialog

**Weight:** 0.0000 (share of project budget)
**Reward:** 0 MCUTS

Show confirmation with appointment details and cancel/reschedule buttons. Write tests/specs/E1T6.json and update tests/commands.json.
