# E2T3 — Blocked Slot Management

**Weight:** 0.0000 (share of project budget)
**Reward:** 0 MCUTS

Implement 'Block 30 min' button in owner chat with inline keyboard. Write tests/specs/E2T3.json and update tests/commands.json.
