# E1T4 — Time Slot Selection

**Weight:** 0.0000 (share of project budget)
**Reward:** 0 MCUTS

Display available 15-min slots respecting barber availability, appointments, and blocked slots. Write tests/specs/E1T4.json and update tests/commands.json.
