# E2T1 — Daily Schedule Notification

**Weight:** 0.0000 (share of project budget)
**Reward:** 0 MCUTS

Send 08:00 AM daily schedule (tomorrow’s appointments) to owner. Write tests/specs/E2T1.json and update tests/commands.json.
