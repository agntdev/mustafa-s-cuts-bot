# E1T1 — Service Selection Dialog

**Weight:** 0.0000 (share of project budget)
**Reward:** 0 MCUTS

Implement /book command with inline keyboard listing services (Haircut, Beard trim, etc.) with prices and durations. Write tests/specs/E1T1.json and append /book to tests/commands.json.
